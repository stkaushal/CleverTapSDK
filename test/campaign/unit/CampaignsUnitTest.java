...
import payload.campaign.campaigncontent.actions.actionurl.MobileActionUrl;
...
public class CampaignsUnitTest {
	...
	public void testGetCampaignReport() throws IOException, InterruptedException {
		...
		PlatformTypeMobile android = new PlatformTypeMobile();
		...
		CampaignToEventProperty campaignToEventProperty = new CampaignToEventProperty();
		campaignToEventProperty.setEventName("dummy");
		campaignToEventProperty.setFromDate(01012020);
		campaignToEventProperty.setToDate(01012021);
		payload.setCampaignSendTo(campaignToEventProperty);
		...
		CampaignToUserID campaignToUserID = new CampaignToUserID();
		List<String> id = new ArrayList<String>();
		id.add("dummy");
		campaignToUserID.setEmail(id);
		campaignToUserID.setFbid(id);
		campaignToUserID.setIdentity(id);
		campaignToUserID.setObjectId(id);
		payload.setSendMessageTo(campaignToUserID);
	...
	public void testCreateCampaignTargetUserEvents() throws IOException, InterruptedException {
		...
		MobileActionUrl androidActionUrl = new MobileActionUrl();
		androidActionUrl.setText("dummy");
		MobileActionUrl iosActionUrl = new MobileActionUrl();
		...
		PlatformTypeMobile platformTypeAndroid = new PlatformTypeMobile();
		...
		PlatformTypeWeb platformTypeChrome = new PlatformTypeWeb();
		...
		PlatformTypeWeb platformTypeFirefox = new PlatformTypeWeb();
		...
		PlatformTypeMobile platformTypeIos = new PlatformTypeMobile();
		...
		PlatformTypeWeb platformTypeSafari = new PlatformTypeWeb();
